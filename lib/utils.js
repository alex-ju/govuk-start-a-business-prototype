...
exports.autoStoreData = function (req, res, next) {
  ...
  const companies = {
    // Participant 1
    10650102: {
      'company-name': 'AJM Greenway Properties Limited',
      'company-number': '10650102',
      'company-type': 'Private Limited Company',
      'company-sector': 'Other letting and operating of own or leased real estate'
    },
    // Participant 2
    12647154: {
      'company-name': 'Ditch & Switch Ltd',
      'company-number': '12647154',
      'company-type': 'Private Limited Company',
      'company-sector': 'Retail sale via mail order houses or via Internet'
    },
    // Participant 3
    12977762: {
      'company-name': 'ALL About The Beer Ltd',
      'company-number': '12977762',
      'company-type': 'Private Limited Company',
      'company-sector': 'Other retail sale not in stores, stalls or markets'
    },
    // Participant 4
    12928001: {
      'company-name': 'Beauty & Botox Ltd',
      'company-number': '12928001',
      'company-type': 'Private Limited Company',
      'company-sector': 'Hairdressing and other beauty treatment'
    },
    // Participant 5
    12698500: {
      'company-name': 'Enhance Beauty Manchester Ltd',
      'company-number': '12698500',
      'company-type': 'Private Limited Company',
      'company-sector': 'Hairdressing and other beauty treatment'
    },
    // Participant 6
    13000385: {
      'company-name': 'Wild About Holidays Ltd',
      'company-number': '13000385',
      'company-type': 'Private Limited Company',
      'company-sector': 'Travel agency activities'
    }
  }

  const crn = req.params.crn || req.session.data.crn

  req.session.data.companies = Object.values(companies)
